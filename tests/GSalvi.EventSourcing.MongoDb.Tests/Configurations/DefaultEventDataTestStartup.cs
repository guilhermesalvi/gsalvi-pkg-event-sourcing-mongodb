...
public class DefaultEventDataTestStartup : IDisposable
{
    ...
    {
        services.AddEventSourcing(setup => { setup.UseMongoDb(configuration); });
    ...
    private static void InitializeDatabase(string connectionString)
    {
        ...
        var collection = database.GetCollection<EventData>("eventData");
